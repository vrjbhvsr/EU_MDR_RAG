...
### 5a. Related is not sufficient

A source that merely mentions a term does not define or explain it. 

If the source only references the concept without providing the 
information asked for, reply: "The answer is not present in the 
provided document." Do not construct a definition from surrounding text.
